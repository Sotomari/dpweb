...
class viewModel
{
   // Método protegido y estático que devuelve la ruta o nombre de la vista solicitada
    ...
    {
        $white_list = ["home", "products", "new-product", "edit-product", "new-user", "category", "new-categoria", "edit-category", "login", "users", "edit-user", "new-venta","pagos","sesiones","ventas","compras","cliente", "new-cliente", "proveedor", "new-proveedor","vista-cliente"];
